...
{
	Date					m_date;
	unsigned int			m_precipitationFrom20OClockTo20OClock;
	int						m_dailyMaximunTempreture;
	int						m_dailyMinimunTempreture;
...
public:
	...
	unsigned int GetPrecipitationFrom20OClockTo20OClock() const;
	void SetPrecipitationFrom20OClockTo20OClock(const unsigned int & PrecipitationFrom20OClockTo20OClock);

	int GetDailyMaximunTempreture() const;
	void SetDailyMaximunTempreture(const int & DailyMaximunTempreture);

	int GetDailyMinimunTempreture() const;
	void SetDailyMinimunTempreture(const int & DailyMinimunTempreture);
};
/*
